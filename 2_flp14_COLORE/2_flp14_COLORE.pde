/*
Basato su: P_1_1_1_01 Generative Gestaltung — Segue licenza originale.
Algoritmo modificato per esercizio durante il corso 
SEI 2014 @ UnirSM — Più info http://goo.gl/59obuO 

Disegna dei cerchi colorati che seguono il mouse, cambiano dimensione e colore
...
void draw(){
  ...
  for (int gridY=0; gridY<height; gridY+=stepY){
    for (int gridX=0; gridX<width; gridX+=stepX){
      ...
      ellipse(gridX, gridY, stepX, stepY);//disegna dei cerchi colorati che seguono il mouse
    }
  }
